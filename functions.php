...
function dina_script_enqueue() {
    ...
    wp_enqueue_style('customstyle', get_template_directory_uri() . '/css/header.css', array(), '1.0.1', 'all');
    wp_enqueue_style('customstyle', get_template_directory_uri() . '/css/footer.css', array(), '1.0.1', 'all');    wp_enqueue_style('customstyle', get_template_directory_uri() . '/css/home.css', array(), '1.0.1', 'all');
